...
$back    = eazyrecruitz_set( $back, 'url', EAZYRECRUITZ_URI . 'assets/images/parallax.png' );
$s_type = '';
$e_tpl = '';
...
if ( class_exists( '\Elementor\Plugin' ) AND $s_type == 'e' AND $e_tpl ) {
	...
	//if ( $s_type != 'none' AND ! empty( $options ) AND $s_type != 'e' ) {
		//eazyrecruitz_template_load( 'templates/footer/footer_set.php' );
	//}
	
	 do_action( 'eazyrecruitz_main_footer' ); 
}
