...
return array(
	'id'     => 'eazyrecruitz_sidebar_settings',
	'title'  => esc_html__( "Eazyrecruitz Sidebar Settings", "konia" ),
	'fields' => array(
		array(
			'id'      => 'sidebar_source_type',
			'type'    => 'button_set',
			'title'   => esc_html__( 'Sidebar Source Type', 'eazyrecruitz' ),
			'options' => array(
		...
		array(
			...
			'options'  => eazyrecruitzs_get_sidebars(),
			'required' => [ 'sidebar_source_type', '=', 'd' ],
		),
	),
);