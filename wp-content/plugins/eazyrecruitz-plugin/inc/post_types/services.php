...
class Services extends Post_Type {
	...
	protected $post_type = 'eazyrecruitz_service';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Service', 'wpeazyrecruitz' );
		self::instance()->plural    = esc_html__( 'Services', 'wpeazyrecruitz' );
