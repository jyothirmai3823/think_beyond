...
class Project extends Post_Type {
	...
	protected $post_type = 'eazyrecruitz_project';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Project', 'wpeazyrecruitz' );
		self::instance()->plural    = esc_html__( 'Projects', 'wpeazyrecruitz' );
