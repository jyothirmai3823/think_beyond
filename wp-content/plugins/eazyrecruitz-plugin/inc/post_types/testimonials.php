...
namespace EAZYRECRUITZPLUGIN\Inc\Post_Types;

use EAZYRECRUITZPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  EAZYRECRUITZPLUGIN/Abstracts
 * @category Abstract Class
 * @author   Wptech
 */
class Testimonials extends Post_Type {

	protected $post_type = 'eazy_testimonials';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wpeazyrecruitz' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wpeazyrecruitz' );
